...
public interface IReq<TRes>
{
    static abstract HttpMethod Method { get; }
    static abstract string Path { get; }
    Task<TRes> Do(HttpClient client);
}

public record TestReq : IReq<TestRes>
{
    public static readonly HttpMethod Method = HttpMethod.Post;
    public static readonly string Path = "/api/test";

    public async Task<TestRes> Do(HttpClient client)
    {
        var req = new HttpRequestMessage(Method, Path);
        req.Content = new StringContent(JsonConverter)
