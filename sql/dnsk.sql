...
GRANT SELECT ON Dnsk.* TO 'Dnsk'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT INSERT ON Dnsk.* TO 'Dnsk'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT UPDATE ON Dnsk.* TO 'Dnsk'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT DELETE ON Dnsk.* TO 'Dnsk'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;
GRANT EXECUTE ON Dnsk.* TO 'Dnsk'@'%' WITH GRANT OPTION MAX_STATEMENT_TIME 10;